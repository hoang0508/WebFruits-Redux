                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-2 gap-x-3">
                      <IconUpdate className="border p-2 border-gray-200 rounded cursor-pointer text-gray-300" />
                      <IconDelete className="border p-2 border-gray-200 rounded cursor-pointer text-gray-300" />
                    </div>
                  </div>
                </div>
              ))}
